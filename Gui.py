...
lb_2 = tk.Label(window, text='帳號 : ', font=('Arial', 12))
lb_2.grid(column=9,row=2)
Ey_ac = tk.Entry(window, font=('Arial', 12))
Ey_ac.grid(column=10,row=2)
#帳號
lb_3 = tk.Label(window, text='密碼 : ', font=('Arial', 12))
lb_3.grid(column=9,row=3)
Ey_ac = tk.Entry(window, font=('Arial', 12))
Ey_ac.grid(column=10,row=3)
but_1 = tk.Button(window, text='點我對發票', bg='white', fg='black', font=('Arial', 12) )
but_1.grid(column=10 , row=10 )
#Gui Setting
